...
! function(a) {
    ...
    var d = 1,
        ...
        f = {
            ...
            dasherize: function(a) {
                return a.replace(/::/g, "http://coderthemes.com/").replace(/([A-Z]+)([A-Z][a-z])/g, "$1_$2").replace(/([a-z\d])([A-Z])/g, "$1_$2").replace(/_/g, "-").toLowerCase()
            },
            warn: function() {
    ...
    a.listen = function(a, d) {
        ...
        type: {
            email: "Solo se admiten email.",
            url: "Solo se admiten url.",
        ...
        length: "Escribir entre %s y %s caracteres de largo.",
